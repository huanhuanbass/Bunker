...
platts_spot=load_platts_data()

if 'platts_spot' not in st.session_state:
    st.session_state['platts_spot']=platts_spot
...
with col1:
    ...
    plattssl['Spread']=platts[spct1]-platts[spct2]
    sspplot=px.line(plattssl['Spread'],width=600,height=400,title=spct1+' Minus '+spct2 +' Spread')
